...
class Dmatrix:
    ...
    def writeMeta(self, test, testtype):
        path = rf"Z:\\eV common\Production\Test & Measurement Results\keV-{testtype}/Unmounted Data/{self.wonumber}"
    ...
    def main(self):
        ...
        config_path = r"Z:\\eV common\Production\Config Files\360_373_unmounted_testing\test_config_left.yaml"
